...
//        final val Hadoop = "2.7.3"
//        final val SparkTestingBase = "2.3.1_0.14.0"
...
//    lazy val Spark = Seq(
//        "org.apache.spark" %% "spark-core" % v.Spark  exclude("org.apache.hadoop", "hadoop-client"),
//        "org.apache.spark" %% "spark-sql" % v.Spark  exclude("org.apache.hadoop", "hadoop-client"),
//        "org.apache.spark" %% "spark-catalyst" % v.Spark  exclude("org.apache.hadoop", "hadoop-client")
//    )
